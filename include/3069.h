...
/*--------------------------------------------------------------*/
/*
typedef enum { // ?��{?��[?��?��?��[?��g?��ݒ胊?��X?��g at 20MHz
  br4800  = 129,
  br9600  = 64,
  br19200 = 32,
  br38400 = 15,
...
typedef enum {  // �{�[���[�g�ݒ胊�X�g at 25MHz
  br4800 = 162,
  br9600 = 80,
  br19200 = 40,
  br38400 = 19,
...
/* ?��C?��?��?��?��?��C?��?��?��?��?��?��                                               */
/*--------------------------------------------------------------*/
// extern inline void sleep(void) __attribute__((always_inline));
// extern inline void nop(void) __attribute__((always_inline));
// extern inline void set_ccr(unsigned char mask)
// __attribute__((always_inline)); extern inline unsigned char get_ccr(void)
// __attribute__((always_inline));

// inline void* get_sp(void) __attribute__((always_inline));
