/*----------------------------------------------------------*
   sci2.c for H8/3067F additional library v1.0
                                       Last Edit '03 03/09
...
#define rs_init     SCI2_INIT
#define rs_rx_buff  SCI2_IN_DATA_CHECK
#define rs_tx_buff  SCI2_OUT_DATA_CHECK
#define rs_rx_purge SCI2_IN_DATA_CLEAR
#define rs_tx_purge SCI2_OUT_DATA_CLEAR
#define rs_putc     SCI2_OUT_DATA
#define rs_puts     SCI2_OUT_STRING
#define rs_putsb    SCI2_OUT_STRINGB
#define rs_getc     SCI2_IN_DATA
#define rs_gets     SCI2_IN_STRING
#define rs_txi      int_txi2
#define rs_rxi      int_rxi2
#define rs_eri      int_eri2

#define FIFO        sci2fifo
#define SCI         SCI2
