...
inline void setInputCapture(bool flag) {
  eommpsys::H8Reg::TMR1.TCSR.BIT.ICE = flag;
}

inline uint8_t getInputCapture(void) {
  return eommpsys::H8Reg::TMR1.TCSR.BIT.ICE;
}

/// CMFAによる割り込みの認可状況
inline bool intrruptStatsA(void) {
  return eommpsys::H8Reg::TMR1.TCSR.BIT.CMFA;
}
/// CMFAのリセット
inline void resetIntrFlagA(void) {
  eommpsys::H8Reg::TMR1.TCSR.BIT.CMFA = 0;
}
/// CMFAによる割り込みの設定(true: 許可 false: 禁止)
inline void permitIntrA(bool flag) {
  eommpsys::H8Reg::TMR1.TCR.BIT.CMIEA = flag;
}
/// CMFAによる割り込みの認可状況
inline bool getPermissionIntrA(void) {
  return eommpsys::H8Reg::TMR1.TCR.BIT.CMIEA;
}
/// TCORBによるコンペアマッチ・インプットキャプチャの発生を示す
inline bool intrruptStatsB(void) {
  return eommpsys::H8Reg::TMR1.TCSR.BIT.CMFB;
}
/// CMFBのリセット
inline void resetIntrFlagB(void) {
  eommpsys::H8Reg::TMR1.TCSR.BIT.CMFB = 0;
}
/// CMFBによる割り込みの設定(true: 許可 false: 禁止)
inline void permitIntrB(bool flag) {
  eommpsys::H8Reg::TMR1.TCR.BIT.CMIEB = flag;
}
/// CMFAによる割り込みの認可状況
inline bool getPermissionIntrB(void) {
  return eommpsys::H8Reg::TMR1.TCR.BIT.CMIEB;
}
/// TCORBによるコンペアマッチ・インプットキャプチャの発生を示す
inline bool intrruptStatsOVF(void) {
  return eommpsys::H8Reg::TMR1.TCSR.BIT.OVF;
}
/// CMFBのリセット
inline void resetIntrFlagOVF(void) {
  eommpsys::H8Reg::TMR1.TCSR.BIT.OVF = 0;
}
/// CMFBによる割り込みの設定(true: 許可 false: 禁止)
inline void permitIntrOVF(bool flag) {
  eommpsys::H8Reg::TMR1.TCR.BIT.OVIE = flag;
}
/// CMFAによる割り込みの認可状況
inline bool getPermissionIntrOVF(void) {
  return eommpsys::H8Reg::TMR1.TCR.BIT.OVIE;
}

/// TCORAを取得する
inline uint8_t getTCORA(void) {
  return eommpsys::H8Reg::TMR1.TCORA;
}
/// TCORAに代入する
inline void setTCORA(uint8_t val) {
  eommpsys::H8Reg::TMR1.TCORA = val;
}
/// TCORBを取得する
inline uint8_t getTCORB(void) {
  return eommpsys::H8Reg::TMR1.TCORB;
}
/// TCORBに代入する
inline void setTCORB(uint8_t val) {
  eommpsys::H8Reg::TMR1.TCORB = val;
}
/// クロックソース選択レジスタの値を計算
...
inline void setClockSource(clockSource_t cs) {
  eommpsys::H8Reg::TMR1.TCR.BIT.CKS = calcClockSource(cs);
}
/// 現在のクロックソース設定の読み出し
inline clockSource_t getClockSource(void) {
  clockSource_t ret_val;
  switch (eommpsys::H8Reg::TMR1.TCR.BIT.CKS) {
    case 0x00:
...
inline void setCounterClearCause(counterClearTrigger_t cause) {
  eommpsys::H8Reg::TMR1.TCR.BIT.CCLR = calcCounterClearCause(cause);
}
/// 設定中のカウンタクリア要因の取得
inline uint8_t getCounterClearCause(void) {
  counterClearTrigger_t ret_val;
  switch (eommpsys::H8Reg::TMR1.TCR.BIT.CCLR) {
    case 0x00:
...
inline void setIOModeA(IOMode_t mode) {
  eommpsys::H8Reg::TMR1.TCSR.BIT.OS = calcIOMode(mode);
}

inline void setIOModeB(IOMode_t mode) {
  eommpsys::H8Reg::TMR1.TCSR.BIT.OIS = calcIOMode(mode);
}
/// タイマーカウントをスタート
